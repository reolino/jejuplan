...
<script type="text/javascript" src="/js/sample/board/update_view.js"></script>
</head>
<body>
	<tag:modal/>
	  	...
	  	<div class="card">
	     	<div class="card-body">
	        	<form id="ifrm" action="#" method="post">
	  				<input type="hidden" id="board_no1" name="board_no" value="${detail.board_no}"/>
				  	...
				  	<div class="template-demo">
				  		...
				  		<button type="button" class="btn btn-danger" onclick="movePage('/sample/board/detail/view/${detail.board_no}')">Back</button>
				  	</div>
				</form>
	       	</div>
	     </div>
