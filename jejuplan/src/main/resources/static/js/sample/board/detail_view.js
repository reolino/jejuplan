...
function commentInsert(){
	var params = $('#comment_frm').serialize(); 
	$.ajax({
   	url : '/sample/comment/insert/proc',
      type : 'post',
      data : params,
      success : function(data){
      	if(data == 1) {
...
function commentUpdateProc(comment_no){
    ...
    $.ajax({
        url : '/sample/comment/update/proc',
        type : 'post',
...
function commentDelete(comment_no){
    $.ajax({
        url : '/sample/comment/delete/proc/'+comment_no,
        type : 'post',
        success : function(data){
            if(data == 1) commentList(); 
        }
